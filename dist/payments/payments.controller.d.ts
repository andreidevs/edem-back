...
export declare class PaymentsController {
    ...
    create(dto: Prisma.PaymentsUncheckedCreateInput): Promise<import(".prisma/client").Payments & {
    ...
    update(id: number, dto: Prisma.PaymentsUncheckedUpdateInput): Promise<import(".prisma/client").Payments & {
        group: import(".prisma/client").Groups;
        coach: {
            id: number;
            name: string;
